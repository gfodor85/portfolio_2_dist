...
try {
    if(isset($_POST['send'])){
        ...
        $mail->Username = 'gfodor85@gmail.com';                 // SMTP username
        $mail->Password = 'Manjushri85';                           // SMTP password
        $mail->SMTPSecure = 'tls';                            // Enable TLS encryption, `ssl` also accepted
        $mail->Port = 587;                                 // TCP port to connect to

        //Recipients
        $mail->setFrom($email, $name);
        $mail->addAddress('gfodor85@gmail.com', 'George Fodor');     // Add a recipient
        ...
        $mail->Email = $email;
        $mail->Body    = $message . "<br> Sent from fuseworks.io";
    ...
    echo 
        '<div id="form-handler" class="form-alert-body">
            <div class="form-alert-text">
